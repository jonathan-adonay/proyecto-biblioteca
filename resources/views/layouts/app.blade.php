...
bstarget="#navbarSupportedContent" aria-controls="navbarSupportedContent" 
ariaexpanded="false" aria-label="{{ __('Toggle navigation') }}">  
...
role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" vpre>  
                                    {{ Auth::user()->name }}  
                                </a>  
